...
open class PagerController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate {
    ...
    open func selectTabAtIndex(_ index: Int, animated:Bool) {
        self.selectTabAtIndex(index, swipe: false, animated: animated)
    }
    ...
    func selectTabAtIndex(_ index: Int, swipe: Bool, animated:Bool? = nil) {
        ...
        self.changeActiveTabIndex(index, animated: animated)
        self.setActiveContentIndex(index, animated: animated)
    ...
    func changeActiveTabIndex(_ newIndex: Int, animated:Bool? = nil) {
        ...
        if !disableTabContentOffsetAnimating {
            self.tabsView!.setContentOffset(frame.origin, animated: shouldAnimate)
        }
    }
    ...
    @nonobjc func setActiveContentIndex(_ activeContentIndex: Int, animated:Bool? = nil) {
        ...
        if activeContentIndex == self.activeContentIndex {
            ...
            DispatchQueue.main.async(execute: {
                self.pageViewController.setViewControllers([viewController!], direction: direction, animated: shouldAnimate, completion: { completed in
                    wSelf?.animatingToTab = false
            ...
            DispatchQueue.main.async(execute: {
                self.pageViewController.setViewControllers([viewController!], direction: direction, animated: shouldAnimate, completion: { _ -> Void in
                    wSelf!.animatingToTab = shouldAnimate
                })
            })
        }
